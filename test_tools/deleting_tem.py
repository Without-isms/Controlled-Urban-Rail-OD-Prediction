...
f"OD{os.path.sep}train_Time_DepartFreDic_Array.pkl",
f"OD{os.path.sep}OD_path_dic.pkl",
f"OD{os.path.sep}val_Time_DepartFreDic_Array.pkl",
f"OD{os.path.sep}train_OD_feature_array.pkl",
f"OD{os.path.sep}test_Time_DepartFreDic_Array.pkl",
f"test_result_array_DO.pkl",
f"train_result_array_DO.pkl",
f"val_result_array_DO.pkl",
f"train_prdc_OD_signal_dict.pkl"
]
